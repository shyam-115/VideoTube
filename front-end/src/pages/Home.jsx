      ...
      <section className="text-center py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/upload"
              className="relative flex w-full sm:w-auto items-center justify-center p-[2px] overflow-hidden text-lg font-medium text-white rounded-xl group bg-gradient-to-br from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 transition-all duration-300 shadow-lg shadow-violet-500/25 active:scale-95"
            >
              <span className="relative px-8 py-3.5 transition-all ease-in duration-75 bg-transparent rounded-[10px] group-hover:bg-opacity-0 flex items-center justify-center w-full">
            ...
            <Link
              to="/search"
              className="relative flex w-full sm:w-auto items-center justify-center p-[2px] overflow-hidden text-lg font-medium text-zinc-900 dark:text-white rounded-xl group bg-gradient-to-br from-zinc-200 to-zinc-300 hover:from-zinc-300 hover:to-zinc-400 dark:from-zinc-800 dark:to-zinc-700 dark:hover:from-zinc-700 dark:hover:to-zinc-600 transition-all duration-300 shadow-sm active:scale-95"
            >
              <span className="relative px-8 py-3.5 transition-all ease-in duration-75 bg-white dark:bg-zinc-900 rounded-[10px] group-hover:bg-opacity-0 flex items-center justify-center w-full">
                Explore Videos
              </span>
            </Link>
          </div>
