...
- 📧 **Email Verification** – Secure 6-digit OTP verification via email for new registrations
...
| Nodemailer | SMTP email delivery for OTPs |
...
SMTP_FROM=noreply@videotube.com
